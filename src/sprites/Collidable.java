...
public interface Collidable {
    /**
     * returns a Rectangle (all Collidable objects in our Project are Rectangular) of the Collidable object.
     * @return **corresponding Rectangle
     */
    Rectangle getCollisionRectangle();
    /**
     * returns a new Velocity adjusted to the collision of the moving object with the Collidable object.
     * @param hitter **Ball**
